...
interface ISuperscribe<T extends TypeMap> extends ISuperscribeBase {
...
declare type SuperscribeStorageOptions = StorageOptions & {
    mode?: 'LocalStorage' | 'MemoryStorage';
};
declare type SuperscribeOptions<IAuthHandler extends IAuth = Auth> = {
...
declare class Superscribe<T extends TypeMap, IAuthHandler extends IAuth = Auth> implements ISuperscribe<T> {
    private _url;
    private _options?;
    private _auth;
    private _transport;
